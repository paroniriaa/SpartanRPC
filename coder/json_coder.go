...
func (coder *JsonCoder) DecodeMessageHeader(header *Message) error {
...
func (coder *JsonCoder) EncodeMessageHeaderAndBody(header *Message, body interface{}) (error error) {
